...
namespace Ppecheny\AjaxBundle\Twig;
...
class AjaxFormExtension extends \Twig_Extension
{
    ...
    {
        return $this->environment->render("PpechenyAjaxBundle:Form:ajaxForm.html.twig", array(
            'options' => $options
        ));
    }
    ...
    public function renderBtn($options)
    {
        ...
        return $this->environment->render("PpechenyAjaxBundle:Form:ajaxFormBtn.html.twig", array(
            'options' => $options
        ));
    }
    ...
    public function addDefaultOptions(&$options)
    {
        ...
        $options['url'] = $router->generate('ppecheny_ajax_form');
        ...
        if (!isset($options['loadingText'])) {
            ...
            $options['loadingText'] = $translator->trans('Loading...', array(), 'PpechenyAjaxBundle');
        }
    }
